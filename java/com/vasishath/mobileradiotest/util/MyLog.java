package com.vasishath.mobileradiotest.util;
...
import com.vasishath.mobileradiotest.BuildConfig;
...
public abstract class MyLog {
	...
	public static void setPackageInfo(String packageName) {
	...
	private static String getPackageInfo() {
		if (gPackageName != null) {
			return String.format("%s", gPackageName);
		}
		return "- none -";
	}
